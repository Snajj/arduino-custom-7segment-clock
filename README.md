...
Instead of using standard segments, the design is based on a stylized segment layout originally created by Youtube content creator called: Posy. The design was adapted and made fully 3D printable.
